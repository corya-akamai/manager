...
const pathToPackage = path.join(__dirname, "../packages/manager/package.json");
...
const isStage = branch === "staging" || branch.startsWith("release/");
const isProd = branch.startsWith("master");

if (isDev || isStage) {
  console.log(`Publishing branch: ${branch}, version: ${pkg.version}`);
