...
export interface PaginationProps<D = unknown> {
...
export interface UsePaginationProps<T extends TableSearchParams> {
  /**
...
export const usePagination = <T extends TableSearchParams, D = unknown>({
