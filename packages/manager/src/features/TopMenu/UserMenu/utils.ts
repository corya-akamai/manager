 ...
 *
 * @returns company name for parent/child/delegate users when available, email in the case of the restricted parent, or undefined for regular users
 */
export const getCompanyNameOrEmail = ({
  ...
  // In all other parent/child/delegate cases, company will be available, as it is a required field.
  return company;
};
