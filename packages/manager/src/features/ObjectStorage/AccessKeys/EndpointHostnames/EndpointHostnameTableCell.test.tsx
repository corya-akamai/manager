...
import { EndpointHostnameTableCell } from './EndpointHostnameTableCell';

describe('EndpointHostnameTableCell', () => {
  it('should render  "None" when there are no regions', () => {
    const storageKeyData = objectStorageKeyFactory.build({
      regions: [],
    });
    const { getByText } = renderWithTheme(
      <EndpointHostnameTableCell storageKeyData={storageKeyData} />
    );
