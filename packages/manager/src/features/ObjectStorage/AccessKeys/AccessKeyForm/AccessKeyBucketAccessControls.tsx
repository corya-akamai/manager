...
import { AccessKeyBucketPermissionsTable } from '../Permissions/AccessKeyBucketPermissionsTable';
...
export const AccessKeyBucketAccessControls = React.memo((props: Props) => {
  ...
  return (
    <>
      ...
      <AccessKeyBucketPermissionsTable checked={checked} {...rest} />
    </>
  );
});
