...
import { RevokeAccessKeyDialog } from './RevokeAccessKey/RevokeAccessKeyDialog';
import { AccessKeyTable } from './Table/AccessKeyTable';
...
export const AccessKeyList = (props: Props) => {
