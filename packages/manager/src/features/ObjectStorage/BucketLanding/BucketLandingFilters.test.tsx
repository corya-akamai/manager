...
vi.mock(
  'src/features/ObjectStorage/hooks/useObjectStorageBucketsByRegions',
  () => ({
...
vi.mock(
  'src/features/ObjectStorage/hooks/useIsObjectStorageGen2Enabled',
  () => ({
...
vi.mock('src/features/ObjectStorage/Partials/RegionMultiSelect', () => ({
...
vi.mock('../Partials/EndpointMultiselect', () => ({
...
describe('BucketLandingFilters', () => {
  ...
  it('renders the filter heading', () => {
    renderWithTheme(<BucketLandingFilters />);
  ...
  it('calls onFiltersChange with the decoded sets', async () => {
    ...
    renderWithTheme(<BucketLandingFilters onFiltersChange={onFiltersChange} />);
    await waitFor(() => {
