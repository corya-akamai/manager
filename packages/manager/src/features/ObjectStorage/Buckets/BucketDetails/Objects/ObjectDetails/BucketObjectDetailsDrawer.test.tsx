...
import { BucketObjectDetailsDrawer } from './BucketObjectDetailsDrawer';

import type { ObjectDetailsDrawerProps } from './BucketObjectDetailsDrawer';
...
describe('BucketObjectDetailsDrawer', () => {
  it('renders formatted size, formatted last modified, truncated URL', async () => {
    ...
    renderWithTheme(<BucketObjectDetailsDrawer {...props} />);
  ...
  it("doesn't show last modified if the the time is invalid", async () => {
    renderWithTheme(
      <BucketObjectDetailsDrawer {...props} lastModified="INVALID DATE" />
    );
  ...
  describe('readableBytes edge cases in Object Storage', () => {
    it('displays bytes correctly for sizes under 1 KB threshold', () => {
      renderWithTheme(<BucketObjectDetailsDrawer {...props} size={1000} />);
    ...
    it('uses base2 calculations (1024-based) for KB display', () => {
      renderWithTheme(<BucketObjectDetailsDrawer {...props} size={1024} />);
    ...
    it('converts base10 MB values correctly to base2 display', () => {
      renderWithTheme(<BucketObjectDetailsDrawer {...props} size={1000000} />);
