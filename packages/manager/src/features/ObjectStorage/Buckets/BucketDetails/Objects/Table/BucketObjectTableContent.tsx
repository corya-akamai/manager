...
import { BucketObjectTableRow } from './BucketObjectTableRow';
...
const BucketObjectTableContent: React.FC<Props> = (props) => {
  const {
    data,
    error,
    handleClickDelete,
...
export default React.memo(BucketObjectTableContent);
